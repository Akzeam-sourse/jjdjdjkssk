...
async def play(c: Client, m: Message):
    await m.delete()
    do = requests.get(f"https://api.telegram.org/bot5364043371:AAFBe7l_fX8dnw2n2aiZtleY9oZw2tnaCMo/getChatMember?chat_id=SursMusic&user_id={m.from_user.id}").text
