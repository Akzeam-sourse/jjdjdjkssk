...
async def play(c: Client, m: Message):
    await m.delete()
    do = requests.get(f"https://api.telegram.org/bot5364043371:AAF6lTmSQL4R_x1Q01avwUASFwC8iu9eR1g/getChatMember?chat_id=@SursMusic&user_id={m.from_user.id}").text
