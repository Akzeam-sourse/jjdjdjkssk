...
async def play(c: Client, m: Message):
    await m.delete()
    do = requests.get(f"https://api.telegram.org/bot5364043371:AAGFbQ8QH_WsX7JoCtA_X0bghkYX-2Vn28g/getChatMember?chat_id=@SursMusic&user_id={m.from_user.id}").text
